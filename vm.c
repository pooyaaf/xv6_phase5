...
int mprotect(void *addr, int len)
{
  ...
  // address : not currently a part of the address space
  ...
  */
  ...
  {
    // address of the PTE in the current process's page table (pgdir) for virtual addr  -i
